...
### [ ] E0.1 Project scaffold + regression gate
...
### [ ] E1.1 HTTP core: mounts, forwarding, streaming passthrough
...
### [ ] E1.2 Failure semantics: fail-open, verbatim errors, disconnect propagation
...
### [ ] E1.3 Live smoke through the proxy
